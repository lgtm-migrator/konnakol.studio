...
const pattern = [
  new Tact(0, [
    ...
    new Roll(4, [
      new Fraction(0, { frequencies: [DKurd.notes[5].frequency], symbol: '5', }),
      new Fraction(1, { frequencies: [DKurd.notes[7].frequency], symbol: '7', color: 'green' }),
    ]),
    ...
    new Chord(7, [
      new Fraction(0, { frequencies: [DKurd.notes[6].frequency], symbol: '6', color: 'green' }),
      new Fraction(1, { frequencies: [DKurd.notes[4].frequency], symbol: '4', color: 'green' })
    ]),
  ])
]
